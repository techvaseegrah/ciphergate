...
import { Camera, Mail, Phone, User, Lock, Save } from 'lucide-react';
...
const Profile = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      // Support all image formats as requested
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await updateWorker(user._id, dataToUpdate);
